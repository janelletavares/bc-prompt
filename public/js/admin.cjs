(function() {
    ...
    http.open("GET", "http://bonoboconnect.com/authentication");
    http.send();
...
function currentPrompts() {
    var http = new XMLHttpRequest();
    http.open("GET", "http://bonoboconnect.com/prompts");
...
function updatePrompts() {
    ...
    var http = new XMLHttpRequest();
    http.open("POST", "http://bonoboconnect.com/prompts");
    http.setRequestHeader("Accept", "application/json");
    http.setRequestHeader("Content-Type", "application/json");
    http.send(value);
}
...
function getIndex() {
    let int = 0
    var http = new XMLHttpRequest();
    http.open("GET", "http://bonoboconnect.com/index");
    http.setRequestHeader("Accept", "application/json");
    http.setRequestHeader("Content-Type", "application/json");
    http.send();
    http.onreadystatechange=(e)=> {
...
function updateIndex() {
    ...
    var http = new XMLHttpRequest();
    http.open("POST", "http://bonoboconnect.com/index");
    http.setRequestHeader("Accept", "application/json");
    http.setRequestHeader("Content-Type", "application/json");
