(function() {
    ...
    http.open("GET", "https://bonoboconnectprompt.com/authentication");
    http.send();
...
function currentPrompts() {
    var http = new XMLHttpRequest();
    http.open("GET", "https://bonoboconnectprompt.com/prompts");
...
function currentPrompt() {
    var http = new XMLHttpRequest();
    http.open("GET", "https://bonoboconnectprompt.com/prompt");
    http.setRequestHeader("Accept", "application/json");
    http.setRequestHeader("Content-Type", "application/json");
    http.send();
    http.onreadystatechange=(e)=>{
...
function updatePrompts() {
    ...
    var http = new XMLHttpRequest();
    http.open("POST", "https://bonoboconnectprompt.com/prompts");
    http.setRequestHeader("Accept", "application/json");
    http.setRequestHeader("Content-Type", "application/json");
    http.send(value);
}
...
function getIndex() {
    let int = 0
    var http = new XMLHttpRequest();
    http.open("GET", "https://bonoboconnectprompt.com/index");
    http.setRequestHeader("Accept", "application/json");
    http.setRequestHeader("Content-Type", "application/json");
    http.send();
    http.onreadystatechange=(e)=> {
...
function updateIndex() {
    ...
    var http = new XMLHttpRequest();
    http.open("POST", "https://bonoboconnectprompt.com/index");
    http.setRequestHeader("Accept", "application/json");
    http.setRequestHeader("Content-Type", "application/json");
